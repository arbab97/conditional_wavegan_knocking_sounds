...
if __name__ == '__main__':
    train_model(sampling_rate = 8192,
                n_batches = 30000,
                batch_size = 64,
                audio_path = '/content/conditional_wavegan_knocking_sounds/All/',
                checkpoints_path = '/content/drive/MyDrive/Colab Notebooks/waveGanforMusictraining/',
